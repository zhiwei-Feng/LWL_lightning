...
class Tracker:
    ...
    def run_sequence(self, seq, visualization=None, debug=None, multiobj_mode=None):
        ...
        if multiobj_mode == 'default' or is_single_object:
            ...
            # focus: 实际上走的这个分支，self.visdom=None
    ...
    def _track_sequence(self, tracker, seq, init_info):
        ...
        # 这里输入的tracker实际上是MultiObjectWrapper
        ...
        # 调用MultiObjectWrapper的initialize方法
        ...
        for frame_num, frame_path in enumerate(tqdm(seq.frames[1:]), start=1):
            # --------------- fixme: 迷惑代码
            while True:
